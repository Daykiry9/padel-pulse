  ...
  return (
    ...
    >
      <button
        ...
        className={`inline-flex min-h-[40px] pointer-coarse:min-h-11 items-center gap-1 rounded-full px-3 py-2 text-xs font-semibold uppercase tracking-wider transition-colors sm:px-4 sm:tracking-[0.15em] ${
          optimistic === 'kings'
