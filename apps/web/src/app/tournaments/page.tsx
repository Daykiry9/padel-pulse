...
function CityChip({ href, active, label }: { href: string; active: boolean; label: string }) {
  return (
    <Link
      href={href}
      className={`focus-card inline-flex items-center rounded-full border px-3 py-1 pointer-coarse:min-h-11 text-xs uppercase tracking-[0.15em] transition-colors ${
        active
